        ...
        <div class="col-12">
            <div class="page-header">
                ...
                <div class="page-rightheader">
                    <a href="<?php echo e(route('admin.fee-management.structures.create')); ?>" class="btn btn-primary">
...
<script>
    $(document).ready(function() {
        $('#structuresTable').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "<?php echo e(route('admin.fee-management.structures.data')); ?>",
                type: 'GET'
            },
            columns: [
                { data: 'id', name: 'id' },
    ...
    function deleteStructure(id) {
        if (confirm('Are you sure you want to delete this structure?')) {
            $.ajax({
                url: "<?php echo e(route('admin.fee-management.structures.delete', '')); ?>/" + id,
                type: 'DELETE',
                data: {
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erpschool\resources\views/admin/fee-management/structures/index.blade.php ENDPATH**/ ?>