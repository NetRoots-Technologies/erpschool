...
<?php if(Gate::allows('students')): ?>
    ...
    <div class="row mt-4 mb-4 justify-content-start gap-4">
        ...
        <div class="col-auto p-0">
            <a href="<?php echo e(route('academic.branch.export-file')); ?>" class="btn btn-warning btn-md">
        ...
        <div class="col-auto p-0">
            <a href="<?php echo e(route('print-preview', 'branches')); ?>" class="btn btn-info btn-md">
                <b>Print Preview</b>
            </a>
        </div>
    ...
    <div class="modal fade" id="importModal" tabindex="-1" aria-labelledby="importModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="<?php echo e(route('academic.branch.import-file')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-md-12">
                                                    ...
                                                    <select class="form-select select2 basic-single" id="schoolType"
                                                        ...
                                                        <?php $__currentLoopData = $schoolTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                tableData = $('#file-datatable').DataTable({
                                ...
                                if (selectedIds.length > 0) {
                                    ...
                                    Swal.fire({
                                        ...
                                        if (result.isConfirmed) {
                                            $.ajax({
                                                url: '<?php echo e(route('hr.branches-bulk')); ?>',
                                                type: 'POST',
                                                data: {
                                                    ids: selectedIds,
                    ...
                    ajax: {
                        "url": "<?php echo e(route('datatable.get-data-branch')); ?>",
                        "type": "POST",
                        "data": {
                            _token: "<?php echo e(csrf_token()); ?>"
                        }
                ...
                $("#createform").validate({
                    ...
                    submitHandler: function (form) {
                        ...
                        var url = "<?php echo e(route('admin.branches.store')); ?>";
                        $.ajax({
                            type: "POST",
                            url: url,
                ...
                $('#tag-form-submit').on('click', function (e) {
                    ...
                    e.preventDefault();
                    var id = $('#edit_id').val();
                    var url = "<?php echo e(route('admin.branches.index')); ?>";
                ...
                $('#file-datatable tbody').on('click', '.change-status', function () {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '<?php echo e(route('hr.branch.change-status')); ?>',
                        data: {
                            id: id,
                            status: status,
                            _token: '<?php echo e(csrf_token()); ?>',
                ...
                $('#file-datatable tbody').on('click', '.sync_data', function () {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '<?php echo e(route('hr.branch.sync-data')); ?>',
                        data: {
                            id: id,
                            _token: '<?php echo e(csrf_token()); ?>',
                        },
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erpschool\resources\views/admin/branches/index.blade.php ENDPATH**/ ?>