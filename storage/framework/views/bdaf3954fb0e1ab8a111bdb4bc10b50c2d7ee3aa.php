...
<?php if(Gate::allows('students')): ?>
    ...
    <div class="row mt-4 mb-4 justify-content-start gap-4" style="padding: 0 0 0 15px;">
     ...
     <?php if(Gate::allows('Departments-create')): ?>
        ...
        <div class="col-auto p-0">
            <a href="<?php echo e(route('academic.department.export-file')); ?>" class="btn btn-warning btn-md">
        ...
        <div class="col-auto p-0">
            <a href="<?php echo e(route('print-preview', 'departments')); ?>" class="btn btn-info btn-md">
                <b>Print Preview</b>
            </a>
    ...
    <div class="modal fade" id="importModal" tabindex="-1" aria-labelledby="importModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="<?php echo e(route('academic.department.import-file')); ?>" method="POST"
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                tableData = $('#file-datatable').DataTable({
                    ...
                    ajax: {
                        "url": "<?php echo e(route('datatable.get-data-department')); ?>",
                        "type": "POST",
            ...
            $('.company_id').on('change', function (e) {
                ...
                $.ajax({
                    type: "post",
                    "url": '<?php echo route('admin.departments.company.get'); ?>',
                    data: {
                        id: id,
            ...
            $('#tag-form-submit').on('click', function (e) {
                ...
                var id = $('#edit_id').val();
                console.log(id);
                var url = "<?php echo e(route('admin.departments.index')); ?>";
            ...
            $('#file-datatable tbody').on('click', '.change-status', function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?php echo e(route('hr.department.change-status')); ?>',
                    data: {
                        id: id,
                        status: status,
                        _token: '<?php echo e(csrf_token()); ?>',
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erpschool\resources\views/admin/department/index.blade.php ENDPATH**/ ?>