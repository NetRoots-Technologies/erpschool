    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            tableData = $('#file-datatable').DataTable({
                                    ...
                                    if (selectedIds.length > 0) {
                                        ...
                                        Swal.fire({
                                            ...
                                            if (result.isConfirmed) {
                                                $.ajax({
                                                    url: '<?php echo e(route('exam.skills-bulk')); ?>',
                                                    type: 'POST',
                                                    data: {
                                                        ids: selectedIds,
                ...
                ajax: {
                    "url": "<?php echo e(route('datatable.skills.getdata')); ?>",
                    "type": "POST",
   ...
   $(document).ready(function () {
    ...
    $("#createform").validate({
        ...
        errorPlacement: function (error, element) {
            ...
            $('#create-form-submit').on('click', function (e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo e(route('exam.skills.store')); ?>",
                    data: formData,
                    processData: false,
                    contentType: false,
                    success: function (response) {
        ...
        $('#tag-form-submit').on('click', function (e) {
            e.preventDefault();
            var id = $('#edit_id').val();
            var url = "<?php echo e(route('exam.skills.index')); ?>";
        ...
        $('#file-datatable tbody').on('click', '.change-status', function () {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo e(route('exam.skills.change-status')); ?>',
                data: {
                    id: id,
                    status: status,
                    _token: '<?php echo e(csrf_token()); ?>',
    ...
    $(document).ready(function() {
        $('#class_id').change(function() {
            ...
            if(classId) {
                $.ajax({
                  url: "<?php echo e(url('get-subjects')); ?>/" + classId,
                    type: 'GET',
...
<script>
    $(document).ready(function() {
        ...
        $('#subject_id').change(function() {
            ...
            if(subjectId) {
                $.ajax({
                    url: "<?php echo e(url('get-components')); ?>/" + subjectId,
                    type: 'GET',
                    success: function(data) {
                        $('#component_id').empty().append('<option value="">Select Component</option>');
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erpschool\resources\views/exam/skills/index.blade.php ENDPATH**/ ?>