...
<div class="modal fade" id="generateBillingModal" tabindex="-1" aria-labelledby="generateBillingModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('admin.fee-management.billing.generate')); ?>" method="POST" id="generateBillingForm">
                <?php echo csrf_field(); ?>
...
<script>
    $(document).ready(function() {
        $('#billingTable').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "<?php echo e(route('admin.fee-management.billing.data')); ?>",
                type: 'GET'
            },
            columns: [
                { data: 'id', name: 'id' },
