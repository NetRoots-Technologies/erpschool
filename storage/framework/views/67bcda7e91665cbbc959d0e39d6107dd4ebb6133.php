...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="row w-100  mt-4 ">
            <h3 class="text-22 text-center text-bold w-100 mb-4"> Exam Term</h3>
        </div>
        <div class="row    mt-4 mb-4 ">
            <div class="col-12 text-right">
                <?php if(Gate::allows('ExamTerms-create')): ?>

                <a href="<?php echo route('exam.exam_terms.create'); ?>" class="btn btn-primary btn-md"><b>Add Exam Term</b></a>
                <?php endif; ?>
            </div>
        </div>
                    ...
                    <div class="card-body table-responsive">
                        <table class="w-100 table border-top-0 table-bordered   border-bottom " id="data_table">
                            ...
                            <tr>
                                ...
                                <th class="heading_style">Term</th>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            var dataTable = $('#data_table').DataTable({
                                        ...
                                        if (selectedIds.length > 0) {
                                            ...
                                            Swal.fire({
                                                ...
                                                if (result.isConfirmed) {
                                                    $.ajax({
                                                        url: '<?php echo e(route('exam.exam-term-bulk')); ?>',
                                                        type: 'POST',
                                                        data: {
                                                            ids: selectedIds,
                ...
                ajax: {
                    "url": "<?php echo e(route('datatable.getExamTerm')); ?>",
                    "type": "POST",
                ...
                "columns": [
                    ...
                    { data: 'progress_heading', name: 'progress_heading' },
                    { data: 'start_date', name: 'start_date' },
                    { data: 'end_date', name: 'end_date' },
                    { data: 'term_desc', name: 'term_desc' },
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erpschool\resources\views/exam/exam_term/index.blade.php ENDPATH**/ ?>