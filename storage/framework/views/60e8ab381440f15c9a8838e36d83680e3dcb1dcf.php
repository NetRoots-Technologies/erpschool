    ...
    <aside class="app-sidebar sidebar-scroll">
        ...
        <div class="main-sidemenu">
            ...
            <li class="slide">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Fee')): ?>
                    <li class="side-item side-item-category">Fee</li>
                    <li class="slide">
                        <a class="side-menu__item <?php echo e(request()->is('admin/fee-structure*', 'admin/fee-sections*', 'admin/account-head*', 'admin/fee-heads*', 'admin/fee-terms*', 'admin/fee-category*', 'admin/student-regular-fee*', 'admin/bill-generation*', 'admin/fee-collection*', 'admin/banks*', 'admin/banks_branches*', 'admin/banks_accounts*', 'admin/banks_file*') ? 'active' : ''); ?>"
                            data-bs-toggle="slide" href="javascript:void(0);">
                            <i class="fas fa-dollar icons8 icon-style" aria-hidden="true"></i>
                        ...
                        <ul class="slide-menu"
                            style="display: <?php echo e(request()->is('admin/fee-structure*', 'admin/fee-sections*', 'admin/account-head*', 'admin/fee-heads*', 'admin/fee-terms*', 'admin/fee-category*', 'admin/student-regular-fee*', 'admin/bill-generation*', 'admin/fee-collection*', 'admin/banks*', 'admin/banks_branches*', 'admin/banks_accounts*', 'admin/banks_file*') ? 'block' : 'none'); ?>">
                            <li><a class="slide-item <?php echo e(request()->is('admin/fee-sections*') ? 'active' : ''); ?>"
                                    href="<?php echo e(route('admin.fee-sections.index')); ?>">Fee Sections</a></li>
                            <li><a class="slide-item <?php echo e(request()->is('admin/account-head*') ? 'active' : ''); ?>"
                                    href="<?php echo e(route('admin.account-head.index')); ?>">Account Head</a></li>
                            <li><a class="slide-item <?php echo e(request()->is('admin/fee-heads*') ? 'active' : ''); ?>"
                                    href="<?php echo e(route('admin.fee-heads.index')); ?>">Fee Head</a></li>
                            <li><a class="slide-item <?php echo e(request()->is('admin/fee-category*') ? 'active' : ''); ?>"
                                    href="<?php echo e(route('admin.fee-category.index')); ?>">Fee Category</a></li>
                            <li><a class="slide-item <?php echo e(request()->is('admin/fee-structure*') ? 'active' : ''); ?>"
                                    href="<?php echo e(route('admin.fee-structure.index')); ?>">Fee Structure</a></li>
                            <li><a class="slide-item <?php echo e(request()->is('admin/student-regular-fee*') ? 'active' : ''); ?>"
                                    href="<?php echo e(route('admin.student-regular-fee.index')); ?>">Student Regular Fee</a></li>
                            <li><a class="slide-item <?php echo e(request()->is('admin/bill-generation*') ? 'active' : ''); ?>"
                                    href="<?php echo e(route('admin.bill-generation.index')); ?>">Bill Generation</a></li>
                            <li><a class="slide-item <?php echo e(request()->is('admin/fee-collection*') ? 'active' : ''); ?>"
                                    href="<?php echo e(route('admin.fee-collection.index')); ?>">Fee Collection</a></li>
                            <li><a class="slide-item <?php echo e(request()->routeIs('admin.banks.*') ? 'active' : ''); ?>"
                                    href="<?php echo e(route('admin.banks.index')); ?>">Bank</a></li>
                            <li><a class="slide-item <?php echo e(request()->routeIs('admin.banks_branches.*') ? 'active' : ''); ?>"
                                    href="<?php echo e(route('admin.banks_branches.index')); ?>">Bank Branches</a></li>
                            <li><a class="slide-item <?php echo e(request()->routeIs('admin.banks_accounts.*') ? 'active' : ''); ?>"
                                    href="<?php echo e(route('admin.banks_accounts.index')); ?>">Bank Account</a></li>
                            <li><a class="slide-item <?php echo e(request()->routeIs('admin.banks_file.*') ? 'active' : ''); ?>"
                                    href="<?php echo e(route('admin.banks_file.index')); ?>">Bank File</a></li>
                        </ul>
                    </li>
                <?php endif; ?>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['Accounts', 'AccountReports', 'Assets'])): ?>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Accounts')): ?>
                        <li class="slide">
                            <a class="side-menu__item <?php echo e(request()->is('admin/ledger_tree*', 'admin/report-center*', 'admin/entries*', 'admin/fee_collection*') ? 'active' : ''); ?>"
                                data-bs-toggle="slide" href="javascript:void(0);">
                            ...
                            <ul class="slide-menu"
                                style="display: <?php echo e(request()->is('admin/ledger_tree*', 'admin/report-center*', 'admin/entries*', 'admin/fee_collection*') ? 'block' : 'none'); ?>">
                                ...
                                <li><a class="slide-item <?php echo e(request()->is('admin/fee_collection*') ? 'active' : ''); ?>"
                                        href="<?php echo e(route('admin.fee_collection_index')); ?>">Fee Collection</a></li>
                            </ul>
                        </li>
                    <?php endif; ?>
...
<?php /**PATH C:\Users\afnan\Desktop\cornerstone\resources\views/admin/layouts/sidebar.blade.php ENDPATH**/ ?>