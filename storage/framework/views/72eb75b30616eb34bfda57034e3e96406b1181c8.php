...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        ...
        <?php if(Gate::allows('Employees-create')): ?>

        <div class="col-auto p-0">
          <a href="<?php echo route('hr.employee.create'); ?>" class="btn btn-primary btn-md"><b>Create Employee</b></a>
        </div>

        
        <div class="col-auto p-0">
            <a href="<?php echo e(config('google_sheet_links.employee_file_link')); ?>" target="_blank" class="btn btn-warning btn-md">
        ...
        <div class="modal fade" id="importModal" tabindex="-1" aria-labelledby="importModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="<?php echo e(route('academic.employee.import-file')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            var dataTable = $('#data_table').DataTable({
                                    ...
                                    if (selectedIds.length > 0) {
                                        ...
                                        Swal.fire({
                                            ...
                                            if (result.isConfirmed) {
                                                $.ajax({
                                                    url: '<?php echo e(route('hr.employee-bulk')); ?>',
                                                    type: 'POST',
                                                    data: {
                                                        ids: selectedIds,
                ...
                ajax: {
                    "url": "<?php echo e(route('datatable.get_data_employee')); ?>",
                    "type": "POST",
            ...
            $('#data_table tbody').on('click', '.employee_attendance', function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?php echo e(route('hr.employee.add-data')); ?>',
                    data: {
                        id: id,
                        _token: '<?php echo e(csrf_token()); ?>',
                    },
            ...
            $('#saveStatus').on('click', function (e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?php echo e(route('hr.employee.change-status')); ?>',
                    data: formData,
                    success: function (response) {
                        loader.remove();
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erpschool\resources\views/hr/employee/index.blade.php ENDPATH**/ ?>