...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid">
        ...
        <?php if(Gate::allows('Section-create')): ?>
            <div class="col-auto">
            ...
            <div class="col-auto">
                <a href="<?php echo e(config('google_sheet_links.section_file_link')); ?>" class="btn btn-warning btn-md" target="_blank">
        ...
        <div class="modal fade" id="importModal" tabindex="-1" aria-labelledby="importModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="<?php echo e(route('academic.section.import-file')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <select name="company_id" class="form-control company_select"
                                                    ...
                                                    <?php $__currentLoopData = $companies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option
                                                            value="<?php echo e($item->id); ?>" selected><?php echo e($item->name); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                            </div>
                                        </div>
            ...
            <script type="text/javascript">
                ...
                $(document).ready(function () {
                    ...
                    tableData = $('#file-datatable').DataTable({
                                            ...
                                            if (selectedIds.length > 0) {
                                                ...
                                                Swal.fire({
                                                    ...
                                                    if (result.isConfirmed) {
                                                        $.ajax({
                                                            url: '<?php echo e(route('academic.section-bulk')); ?>',
                                                            type: 'POST',
                                                            data: {
                                                                ids: selectedIds,
                        ...
                        ajax: {
                            "url": "<?php echo e(route('datatable.get-data-section')); ?>",
                            "type": "POST",
                ...
                $('#create-form-submit').on('click', function (e) {
                    ...
                    var url = "<?php echo e(route('academic.sections.store')); ?>";
                    $.ajax({
                        type: "post",
                        "url": url,
                ...
                $('#file-datatable tbody').on('click', '.sections_edit', function () {
                    ...
                    $.ajax({
                        type: 'GET',
                        url: '<?php echo e(route('academic.fetchClass')); ?>',
                        data: {
                    ...
                    $.ajax({
                        type: 'GET',
                        url: '<?php echo e(route('academic.fetch.active_sessions')); ?>',
                        data: {
                ...
                $('#tag-form-submit').on('click', function (e) {
                    ...
                    var url = "<?php echo e(route('academic.sections.index')); ?>";
                    $.ajax({
                        type: "put",
                        "url": url + '/' + id,
                ...
                $('#file-datatable tbody').on('click', '.change-status', function () {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '<?php echo e(route('academic.section.change-status')); ?>',
                        data: {
                            id: id,
                            status: status,
                            _token: '<?php echo e(csrf_token()); ?>',
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erpschool\resources\views/acadmeic/section/index.blade.php ENDPATH**/ ?>