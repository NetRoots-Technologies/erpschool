...
class MaintainerController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (Auth::user()->can('create maintainer')) {
            ...
            return redirect()->route('maintainer.maintainer.index')->with('success', 'Maintainer successfully created.');
        } else {
            return redirect()->back()->with('error', __('Permission Denied!'));
        }
    }
    ...
    public function update(Request $request, Maintainer $maintainer)
    {
        if (Auth::user()->can('edit maintainer')) {
            ...
            return redirect()->route('maintainer.maintainer.index')->with('success', 'Maintainer successfully updated.');
        } else {
            return redirect()->back()->with('error', __('Permission Denied!'));
        }
    }
