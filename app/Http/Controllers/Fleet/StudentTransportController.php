...
class StudentTransportController extends Controller
{
    ...
    {
        $students = Students::where('transport_required', true)
    ...
    {
        $students = Students::where('transport_required', true)->get();
        $vehicles = Vehicle::where('status', 'active')->get();
        $routes = Route::where('status', 'active')->get();
    ...
    public function update(Request $request, $id)
    {
        ...
        // This would typically update a record in a student_transportations table
