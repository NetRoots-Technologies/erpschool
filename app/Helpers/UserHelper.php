...
class UserHelper
{
    ...
    {
        if (self::getUserRole() == 'Super Admin') {
            return true;
        } else {
            return false;
        }
    ...
    /**
     * Check if current user is Super Admin with all permissions
     *
     * @return bool
     */
    public static function isSuperAdmin()
    {
        ...
        // Check if Super Admin role has all permissions
        $permissionManager = app(\App\Services\PermissionManager::class);
        $summary = $permissionManager->getRolePermissionsSummary('Super Admin');

        return $summary['has_all_permissions'] ?? false;
    }

    /**
     * Sync Super Admin permissions (useful when new modules are added)
     *
     * @return array
     */
    public static function syncSuperAdminPermissions()
    {
        return \App\Services\PermissionManager::syncAdminPermissions(['Super Admin']);
    }
