            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        ...
                        <a href="{{ route('fleet.transportation.show', $transportation->id) }}" class="btn btn-info btn-sm">
                            <i class="fa fa-eye"></i> View
                        </a>
                    </div>
                </div>
                <div class="card-body">
                    <form action="{{ route('fleet.transportation.update', $transportation->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" 
                                           value="{{ $transportation->student->first_name }} {{ $transportation->student->last_name }} ({{ $transportation->student->student_id }})" 
                                           readonly>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('status') is-invalid @enderror" 
                                        ...
                                        <option value="inactive" {{ old('status', $transportation->status) == 'inactive' ? 'selected' : '' }}>
                                            Inactive
                                        </option>
                                    </select>
                                    @error('status')
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('vehicle_id') is-invalid @enderror" 
                                        ...
                                        @foreach($vehicles as $vehicle)
                                            <option value="{{ $vehicle->id }}" {{ old('vehicle_id', $transportation->vehicle_id) == $vehicle->id ? 'selected' : '' }}>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('route_id') is-invalid @enderror" 
                                        ...
                                        @foreach($routes as $route)
                                            <option value="{{ $route->id }}" {{ old('route_id', $transportation->route_id) == $route->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('monthly_charges') is-invalid @enderror" 
                                           ...
                                           value="{{ old('monthly_charges', $transportation->monthly_charges) }}" min="0" step="0.01" required>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('notes') is-invalid @enderror" 
                                              id="notes" name="notes" rows="3">{{ old('notes', $transportation->notes) }}</textarea>
                                    @error('notes')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary">
                                <i class="fa fa-save"></i> Update Transportation Assignment
                            </button>
