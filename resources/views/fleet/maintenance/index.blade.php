                                ...
                                <tbody>
                                    @forelse($maintenances as $maintenance)
                                        <tr>
                                            ...
                                            <td>{{ $maintenance->maintenance_date ? $maintenance->maintenance_date->format('d M Y') : 'N/A' }}
                                            </td>
                                            <td>{{ $maintenance->next_maintenance_date ? $maintenance->next_maintenance_date->format('d M Y') : 'N/A' }}
                                            </td>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    ...
                                                    @if (Gate::allows('Fleet-maintenance-delete'))
                                                        <form
                                                            action="{{ route('fleet.maintenance.destroy', $maintenance->id) }}"
