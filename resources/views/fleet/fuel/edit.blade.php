        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Edit Fuel Record</h3>
                    <div class="card-tools">
                        <a href="{{ route('fleet.fuel.index') }}" class="btn btn-secondary btn-sm">
                            <i class="fa fa-arrow-left"></i> Back to Fuel Records
                        </a>
                        <a href="{{ route('fleet.fuel.show', $fuel->id) }}" class="btn btn-info btn-sm">
                            <i class="fa fa-eye"></i> View
                        </a>
                    </div>
                </div>
                <div class="card-body">
                    <form action="{{ route('fleet.fuel.update', $fuel->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('fuel_date') is-invalid @enderror" 
                                           ...
                                           value="{{ old('fuel_date', $fuel->fuel_date ? $fuel->fuel_date->format('Y-m-d') : '') }}" required>
                                    @error('fuel_date')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2 @error('fuel_type') is-invalid @enderror" 
                                        ...
                                        <option value="petrol" {{ old('fuel_type', $fuel->fuel_type) == 'petrol' ? 'selected' : '' }}>Petrol</option>
                                        <option value="cng" {{ old('fuel_type', $fuel->fuel_type) == 'cng' ? 'selected' : '' }}>CNG</option>
                                        <option value="lpg" {{ old('fuel_type', $fuel->fuel_type) == 'lpg' ? 'selected' : '' }}>LPG</option>
                                    </select>
                                    @error('fuel_type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('quantity') is-invalid @enderror" 
                                           ...
                                           value="{{ old('quantity', $fuel->quantity) }}" min="0" step="0.01" required>
                                    @error('quantity')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('rate_per_liter') is-invalid @enderror" 
                                           ...
                                           value="{{ old('rate_per_liter', $fuel->rate_per_liter) }}" min="0" step="0.01" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('total_cost') is-invalid @enderror" 
                                           ...
                                           value="{{ old('total_cost', $fuel->total_cost) }}" min="0" step="0.01" required>
                                    @error('total_cost')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('odometer_reading') is-invalid @enderror" 
                                           ...
                                           value="{{ old('odometer_reading', $fuel->odometer_reading) }}" min="0">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('notes') is-invalid @enderror" 
                                              id="notes" name="notes" rows="3">{{ old('notes', $fuel->notes) }}</textarea>
                                    @error('notes')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary">
                                <i class="fa fa-save"></i> Update Fuel Record
                            </button>
