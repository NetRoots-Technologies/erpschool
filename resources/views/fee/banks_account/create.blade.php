    ...
    <div class="row">
        <div class="col-12">
            <div class="card basic-form">
                <div class="card-body">
                    <h3 class="text-22 text-midnight text-bold mb-4"> Create Bank Account</h3>
                    ...
                    <form action="{!! route('admin.banks_accounts.store') !!}" enctype="multipart/form-data"
                            ...
                            <div class="box-body" style="margin-top:20px;">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="bank_id" class="form-control select2 basic-single bank" required>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="bank_branch_id"
                                            class="form-control  select2 basic-single bank_branch" required
                                            id="companySelect">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select
                                            ...
                                            <option value="MOA" selected >MOA - Money Operational Account</option>
                                            <option value="MCA">MCA - Money Collection Account</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" class="form-control" name="bank_account_no"
                                            required>
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                data.forEach(function (branch) {
                                    branchesDropdown.append('<option value="' + branch.id + '">' + branch.branch_name + '</option>');
                                });
                            },
