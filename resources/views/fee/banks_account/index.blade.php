...
@section('content')
    <div class="container-fluid">
        <div class="row w-100  mt-4 ">
            <h3 class="text-22 text-center text-bold w-100 mb-4"> Bank Account</h3>
        </div>
        <div class="row    mt-4 mb-4 ">
@if (Gate::allows('BanksAccounts-create'))
            <div class="col-12 text-right">
                <a href="{!! route('admin.banks_accounts.create') !!}" class="btn btn-primary btn-md"><b>Add  Bank Account</b></a>
            </div>
            @endif
        </div>
                    ...
                    <div class="card-body table-responsive">
                        <table class="w-100 table border-top-0 table-bordered   border-bottom " id="data_table">
                            ...
                            <tr>
                                ...
                                <th class="heading_style">Bank Branch</th>
                                <th class="heading_style">Account Number</th>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            var dataTable = $('#data_table').DataTable({
                                    ...
                                    if (selectedIds.length > 0) {
                                        ...
                                        Swal.fire({
                                            ...
                                            if (result.isConfirmed) {
                                                $.ajax({
                                                    url: '{{ route('admin.banks_account-bulk') }}',
                                                    type: 'POST',
                                                    data: {
                                                        ids: selectedIds,
                                                        "_token": "{{ csrf_token() }}",
                ...
                ajax: {
                    "url": "{{ route('datatable.getBanksAccount') }}",
                    "type": "POST",
