...
@if (Gate::allows('TestTypes-create'))
            ...
            var tableData = null;
                    $(document).ready(function () {
                        ...
                        tableData = $('#file-datatable').DataTable({
                            ...
                            ajax: {
                                "url": "{{ route('datatable.test_type.getdata') }}",
                                "type": "POST",
                    ...
                    $('#create-form-submit').on('click', function (e) {
                        ...
                        var url = "{{ route('exam.test_types.store') }}";
                    ...
                    $('#tag-form-submit').on('click', function (e) {
                        e.preventDefault();
                        var id = $('#edit_id').val();
                        var url = "{{ route('exam.test_types.index') }}";
                        var loader = $('<div class="loader"></div>').appendTo('body');
                    ...
                    $('#file-datatable tbody').on('click', '.change-status', function () {
                        ...
                        $.ajax({
                            type: 'POST',
                            url: '{{route('exam.test-type.change-status')}}',
                            data: {
                                id: id,
                                status: status,
                                _token: '{{ csrf_token() }}',
