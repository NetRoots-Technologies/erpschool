...
@section('content')
    <div class="container-fluid">
        <div class="row w-100  mt-4 ">
            <h3 class="text-22 text-center text-bold w-100 mb-4"> Marks Input</h3>
        </div>
        <div class="row    mt-4 mb-4 ">
        @if (Gate::allows('MarksInput-create'))
            <div class="col-12 text-right">
                <a href="{!! route('exam.marks_input.create') !!}" class="btn btn-primary btn-md"><b>Add Marks Input</b></a>
            </div>
         @endif
        </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            var dataTable = $('#data_table').DataTable({
                                    ...
                                    if (selectedIds.length > 0) {
                                        ...
                                        Swal.fire({
                                            ...
                                            if (result.isConfirmed) {
                                                $.ajax({
                                                    url: "{{ route('exam.marks-input-bulk') }}",
                                                    type: 'POST',
                                                    data: {
                                                        ids: selectedIds,
                                                        "_token": "{{ csrf_token() }}",
                ...
                ajax: {
                    "url": "{{ route('datatable.getMarksInput') }}",
                    "type": "POST",
