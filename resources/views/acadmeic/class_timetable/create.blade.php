        ...
        <div class="row">
            <div class="col-12">
                <div class="card basic-form">
                    <div class="card-body">
                        <h3 class="text-22 text-midnight text-bold mb-4"> Create ClassTimetable</h3>
                        <div class="row mt-4 mb-4 ">
                            <div class="col-12 text-right">
                                <a href="{!! route('academic.class_timetable.index') !!}"
                        ...
                        @endif
                        <form action="{!! route('academic.class_timetable.store') !!}" enctype="multipart/form-data"
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select required name="days"
                                                    ...
                                                    @for($i = 1; $i <= 6; $i++)
                                                        <option
                                                            value="{{ $i }}">{{ \App\Helpers\UserHelper::getDayName($i) }}</option>
                                                    @endfor
                                                </select>
                                            </div>
                                        </div>
            ...
            $('.select_class').on('change', function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        sectionDropdown.append('<option disabled value="">Select Section</option>');
            ...
            $('.select_class').on('change', function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        courseDropdown.append('<option value="" disabled>Select course</option>');
