        ...
        <div class="row">
            <div class="col-12">
                <div class="card basic-form">
                    <div class="card-body">
                        <h3 class="text-22 text-midnight text-bold mb-4"> Assign Class</h3>
                        ...
                        @endif
                        <form action="{!! route('academic.assign_class.store') !!}" enctype="multipart/form-data"
        ...
        $('.select_course').on('change', function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    TimetableDropdown.append('<option value="' + data.id + '">' + data.name + '</option>');
                    // });
                },
                error: function (error) {
                    console.error('Error fetching branches:', error);
