...
@section('content')
    <div class="container-fluid">
        <div class="row w-100  mt-4 ">
            <h3 class="text-22 text-center text-bold w-100 mb-4"> Assign Time Table
            </h3>
        </div>
        <div class="row    mt-4 mb-4 ">
      @if (Gate::allows('AssignTimetable-create'))
            <div class="col-12 text-right">
                <a href="{!! route('academic.assign_timetable.create') !!}" class="btn btn-primary btn-md"><b>Assign Time Table
                    </b></a>
            </div>
        @endif
        </div>
                    ...
                    <div class="card-body table-responsive">
                        <table class="w-100 table border-top-0 table-bordered   border-bottom " id="data_table">
                            ...
                            <tr>
                                ...
                                <th class="heading_style">Teacher</th>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            var dataTable = $('#data_table').DataTable({
                ...
                ajax: {
                    "url": "{{ route('datatable.get-data-assignTime') }}",
                    "type": "POST",
