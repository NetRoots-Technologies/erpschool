...
<div class="container-fluid">
                                ...
                                <div class="form-group">
                                    <form id="createform">
                                        ...
                                        {{-- <div class="row mt-3">--}}
                                            ...
                                            {{-- <div class="col-md-6">--}}
                                                {{-- <label id="modal_name1"><b>School Type</b></label>--}}
                                                {{-- <select required name="school_type_id" --}} {{--
                                                    class="form-select" --}} {{--
                                                    aria-label=".form-select-lg example">--}}
                                ...
                                <div class="row">
                                    {{-- <div class="row mt-3">--}}
                                        {{-- <div class="col-md-6">--}}
                                            {{-- <label id="modal_name"><b>Company</b></label>--}}
                                            {{-- <select required name="company_id" --}} {{-- class="form-select"
                                                id="company_edit" --}} {{-- aria-label=".form-select-lg example">--}}
                                                {{-- <option value="">Select Company</option>--}}
                                                {{-- @foreach($companies as $item)--}}
                                            ...
                                            {{-- </div>--}}
                                        {{-- <div class="col-md-6">--}}
                                            {{-- <label style="margin-right: 120px"><b>School Type</b></label>--}}
                                            {{-- <select required name="school_type_id" --}} {{-- class="form-select"
                                                id="school_edit" --}} {{-- aria-label=".form-select-lg example">--}}
                                                {{-- <option value="">Select School</option>--}}
                                                {{-- @foreach($schools as $item)--}}
                                                {{-- <option value="{{$item->id}}" selected>{{$item->name}}</option>--}}
                                                {{-- @endforeach--}}
    ...
    <div class="modal fade" id="importModal" tabindex="-1" aria-labelledby="importModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form action="{{route('academic.session.import-file')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-header">
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                tableData = $('#file-datatable').DataTable({
                                        ...
                                        if (selectedIds.length > 0) {
                                            ...
                                            Swal.fire({
                                                ...
                                                if (result.isConfirmed) {
                                                    $.ajax({
                                                        url: '{{ route('academic.academic-session-bulk') }}',
                                                        type: 'POST',
                                                        data: {
                                                            ids: selectedIds,
                                                            "_token": "{{ csrf_token() }}",
                    ...
                    ajax: {
                        "url": "{{ route('datatable.academic.getsession') }}",
                        "type": "POST",
            ...
            $('#create-form-submit').on('click', function (e) {
                e.preventDefault();
                var url = "{{ route('academic.academic-session.store') }}";
            ...
            $('#tag-form-submit').on('click', function (e) {
                e.preventDefault();
                var id = $('#edit_id').val();
                var url = "{{ route('academic.academic-session.index') }}";
            ...
            $('#file-datatable tbody').on('click', '.change-status', function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{route('academic.academicSession.change-status')}}',
                    data: {
                        id: id,
                        status: status,
                        _token: '{{ csrf_token() }}',
