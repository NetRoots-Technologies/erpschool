...
@section('content')
    <div class="container-fluid">
        <div class="row w-100  mt-4 ">
            <h3 class="text-22 text-center text-bold w-100 mb-4">     Timetable
            </h3>
        </div>
        <div class="row    mt-4 mb-4 ">
        @if (Gate::allows('ClassTimetable-create'))
            <div class="col-12 text-right">
                <a href="{!! route('academic.timetables.create') !!}" class="btn btn-primary btn-md"><b>Create Timetable
                    </b></a>
            </div>
           @endif
        </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $('#data_table').DataTable({
                ...
                ajax: {
                    "url": "{{ route('datatable.get-data-timetable') }}",
                    "type": "POST",
