    ...
    <div class="modal fade" id="importModal" tabindex="-1" aria-labelledby="importModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('academic.class.import-file') }}" method="POST" enctype="multipart/form-data">
                    @csrf
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                tableData = $('#file-datatable').DataTable({
                                        ...
                                        if (selectedIds.length > 0) {
                                            ...
                                            Swal.fire({
                                                ...
                                                if (result.isConfirmed) {
                                                    $.ajax({
                                                        url: '{{ route('academic.classes-bulk') }}',
                                                        type: 'POST',
                                                        data: {
                                                            ids: selectedIds,
                                                            "_token": "{{ csrf_token() }}",
                    ...
                    ajax: {
                        "url": "{{ route('datatable.get-data-class') }}",
                        "type": "POST",
            ...
            $('#create-form-submit').on('click', function (e) {
                ...
                var url = "{{ route('academic.classes.store') }}";
                $.ajax({
                    type: "post",
                    "url": url,
            ...
            $('#file-datatable tbody').on('click', '.change-status', function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{route('academic.class.change-status')}}',
                    data: {
                        id: id,
                        status: status,
                        _token: '{{ csrf_token() }}',
