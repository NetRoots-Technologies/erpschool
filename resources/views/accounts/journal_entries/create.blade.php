...
@section('css')
<style>
    /* ===== JOURNAL ENTRY CREATE - PREMIUM THEME ===== */
    @import url('https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;500;600;700&display=swap');
    
    .journal-create-wrapper {
...
@section('content')
<div class="journal-create-wrapper">
    {{-- Hero Header --}}
    ...
    <form action="{{ route('accounts.journal.store') }}" method="POST" id="journalForm">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="reference" class="form-input" value="{{ old('reference') }}" placeholder="e.g., INV-001, CHQ-123">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="voucher-types">
                                <div class="voucher-type-card jv">
                                    <input type="radio" name="entry_type" value="journal_voucher" checked>
                                ...
                                <div class="voucher-type-card cpv">
                                    <input type="radio" name="entry_type" value="cash_payment_voucher">
                                    <div class="voucher-type-label">
                                        <div class="voucher-type-icon">
                                ...
                                <div class="voucher-type-card bpv">
                                    <input type="radio" name="entry_type" value="bank_payment_voucher">
                                    <div class="voucher-type-label">
                                        <div class="voucher-type-icon">
                                ...
                                <div class="voucher-type-card crv">
                                    <input type="radio" name="entry_type" value="cash_receipt_voucher">
                                    <div class="voucher-type-label">
                                        <div class="voucher-type-icon">
                                ...
                                <div class="voucher-type-card brv">
                                    <input type="radio" name="entry_type" value="bank_receipt_voucher">
                                    <div class="voucher-type-label">
                                        <div class="voucher-type-icon">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group mb-0">
                            ...
                            <textarea name="description" class="form-textarea" rows="2" required placeholder="Enter the purpose or details of this journal entry...">{{ old('description') }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="lines-table-wrapper" style="border: none; border-radius: 0;">
                    <table class="lines-table" id="linesTable">
                        ...
                        <tbody id="linesBody">
                            <tr class="line-row">
                                <td>
                                    <select name="lines[0][account_ledger_id]" class="line-select" required>
                                ...
                                <td>
                                    <input type="text" name="lines[0][description]" class="line-input" placeholder="Line description">
                                </td>
                                <td>
                                    <input type="number" step="0.01" name="lines[0][debit]" class="line-input amount-input debit-input" value="0" min="0" oninput="calculateTotals()">
                                </td>
                                <td>
                                    <input type="number" step="0.01" name="lines[0][credit]" class="line-input amount-input credit-input" value="0" min="0" oninput="calculateTotals()">
                                </td>
                                <td style="text-align: center;">
                                    <button type="button" class="btn-remove-line" onclick="removeLine(this)" disabled>
                            ...
                            <tr class="line-row">
                                <td>
                                    <select name="lines[1][account_ledger_id]" class="line-select" required>
                                        <option value="">Select Account</option>
                                        @foreach($ledgers as $ledger)
                                            <option value="{{ $ledger->id }}">{{ $ledger->code }} - {{ $ledger->name }}</option>
                                        @endforeach
                                ...
                                <td>
                                    <input type="text" name="lines[1][description]" class="line-input" placeholder="Line description">
                                </td>
                                <td>
                                    <input type="number" step="0.01" name="lines[1][debit]" class="line-input amount-input debit-input" value="0" min="0" oninput="calculateTotals()">
                                </td>
                                <td>
                                    <input type="number" step="0.01" name="lines[1][credit]" class="line-input amount-input credit-input" value="0" min="0" oninput="calculateTotals()">
                                </td>
                                <td style="text-align: center;">
        ...
        <div class="action-footer">
            <div class="auto-post-option">
                <label class="custom-checkbox">
                    <input type="checkbox" name="auto_post" value="1" id="auto_post">
                    <span class="checkmark"></span>
                </label>
                <label class="auto-post-label" for="auto_post">
                    <strong>Post immediately</strong> — Entry will be final and cannot be edited
                </label>
            </div>
