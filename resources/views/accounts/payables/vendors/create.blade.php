...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">Create New Vendor</h4>
...
<form action="{{ route('accounts.payables.vendors.store') }}" method="POST">
    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <small class="text-muted">Unique code (e.g., VEN-001)</small>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="alert alert-info">
                        <i class="fa fa-info-circle"></i> A ledger account will be automatically created for this vendor in Accounts Payable.
                    </div>
                    
                    <div class="alert alert-warning">
                        <strong>Note:</strong> Make sure the vendor code is unique and follows your naming convention.
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    <button type="submit" class="btn btn-primary w-100">
                        <i class="fa fa-save"></i> Create Vendor
                    </button>
                </div>
            </div>
        </div>
