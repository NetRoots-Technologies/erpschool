...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">Accounts Payable Dashboard</h4>
        </div>
    </div>
</div>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div class="flex-grow-1">
                        <p class="text-uppercase fw-medium text-muted mb-0">Total Payable</p>
                    </div>
                </div>
                <div class="d-flex align-items-end justify-content-between mt-4">
                    <div>
                        <h4 class="fs-22 fw-semibold ff-secondary mb-4">
                            <span class="text-danger">Rs. {{ number_format($summary['total_payable'], 2) }}</span>
                        </h4>
                    </div>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">Outstanding Bills</h4>
                <a href="{{ route('accounts.payables.bills.index') }}" class="btn btn-sm btn-primary">View All Bills</a>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            @empty
                            <tr>
                                <td colspan="8" class="text-center">No outstanding bills</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
