        ...
        <div class="row">
            <div class="col-12">
                <div class="card basic-form">
                    <div class="card-body">
                        <h3 class="text-22 text-midnight text-bold mb-4">Edit Department</h3>
                        ...
                        @endif
                        <form action="{!! route('hr.department.update',$department->id) !!}" enctype="multipart/form-data"
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <select class="form-control" name="status">
                                                ...
                                                <option
                                                    @if($department->status == 2)  selected @endif
