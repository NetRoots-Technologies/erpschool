        ...
        <div class="row">
            <div class="col-12">
                <div class="card basic-form">
                    <div class="card-body">
                        <h3 class="text-22 text-midnight text-bold mb-4"> Create Rental Tax</h3>
                        <div class="row    mt-4 mb-4 ">
                            <div class="col-12 text-right">
                                <a href="{!! route('hr.tax-slabs.index') !!}" class="btn btn-primary btn-sm "> Back </a>
                            </div>
                        </div>
                        @if ($errors->any())
                            ...
                            <div class="w-100 p-3">
                                <div class="box-body">
                                    ...
                                    <table class="table table-bordered table-striped" style="margin-top: 10px">
                                        ...
                                        <input type="hidden" name="section_name" value="tax-slabs">
                                        ...
                                        @foreach($taxes as $tax)
                                            <tr>
                                                ...
                                                <td><input type="number" class="form-control" required name="tax_percent[]" value="{{ $tax->tax_percent }}"></td>
        ...
        $(document).ready(function () {
            ...
            $('#add-row-btn').click(function () {
                var newRow = '<tr>' +
                    ...
                    '</select>' +
                    '</td>' +
                    '<td><input type="number" required class="form-control" name="fix_amount[]"></td>' +
                    '<td><input type="number" required class="form-control" name="tax_percent[]"></td>' +
