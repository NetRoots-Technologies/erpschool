                                ...
                                <div class="box-body" style="margin-top:50px;">
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-lg-6">
                                            ...
                                            <select required name="status" id="status" type="text"
                                                    class="form-control">
                                                <option @if($agent->status == 1)  selected @endif value="1">Active</option>
                                                <option @if($agent->status == 0)  selected @endif value="0">InActive</option>
