        ...
        <div class="row">
            <div class="col-12">
                <div class="card basic-form">
                    <div class="card-body">
                        <h3 class="text-22 text-midnight text-bold mb-4"> Create Employee Welfare </h3>
                        <div class="row    mt-4 mb-4 ">
                            <div class="col-12 text-right">
                                <a href="{!! route('hr.employee-welfare.index') !!}" class="btn btn-primary btn-sm "> Back </a>
                            </div>
                        </div>
                        @if ($errors->any())
                        ...
                        @endif
                        <form action="{!! route('hr.employee-welfare.store') !!}" enctype="multipart/form-data"
    ...
    <script>
        $("#Load").click(function () {
            ...
            $.ajax({
                ...
                url: "{{route('hr.employeeWelfare.data')}}",
                type: 'POST',
                data: {
                    'branch_id': branch_id,
                    'department_id': department_id,
