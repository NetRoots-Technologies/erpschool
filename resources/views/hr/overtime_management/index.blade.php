...
@section('content')
    <div class="container-fluid">
        <div class="row w-100  mt-4 ">
            <h3 class="text-22 text-center text-bold w-100 mb-4">OverTime</h3>
        </div>

        <div class="row    mt-4 mb-4 ">
@if (Gate::allows('students'))
                <div class="col-12 text-right">
                    <a href="{!! route('hr.overtime.create') !!}" class="btn btn-primary btn-md"><b>Add OverTime</b></a>
                </div>
 @endif
        </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            var dataTable = $('#data_table').DataTable({
                ...
                ajax: {
                    "url": "{{ route('datatable.data.overtimeData') }}",
                    "type": "POST",
