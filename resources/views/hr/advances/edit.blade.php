        ...
        <div class="row">
            <div class="col-12">
                <div class="card basic-form">
                    <div class="card-body">
                        <h3 class="text-22 text-midnight text-bold mb-4"> Edit Advances </h3>
                        ...
                        @endif
                        <form action="{!! route('hr.advances.update',$advance->id) !!}" enctype="multipart/form-data"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select id="employee_id" required name="employee_id"
                                        ...
                                        @foreach($employees as $employee)
                                            <option
                                                value="{{$employee->id}}" {!! $advance->employee_id == $employee->id ? 'selected' : '' !!}>{{$employee->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-6">
                                    <label for="name">Name <b>*</b></label>
                                    <input type="text" class="form-control" value="{!! $advance->name !!}" name="name">
                                </div>
                            </div>
                            ...
                            <div class="row mt-2">
                                <div class="col-md-4">
                                    ...
                                    <input type="number" id="amount" value="{!! $advance->amount !!}"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select id="duration" required name="duration"
                                        ...
                                        @foreach($durations as $duration)
                                            <option
                                                value="{{$duration}}" {!! $advance->duration == $duration ? 'selected' : '' !!}>{{$duration}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-4">
                                    <label for="effective">Effective From <b>*</b></label>
                                    <input type="date" name="start_date" value="{!! $advance->effective_from !!}"
                                           class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-md-4">
                                    ...
                                    <input type="number" class="form-control"
                                           value="{!! $advance->installmentAmount !!}" readonly name="installmentAmount"
                                           id="installmentAmount">
                                </div>
                                <div class="col-md-4">
                                    <label for="amount">Amount To pay <b>*</b></label>
                                    <input type="number" class="form-control" id="amountToPay"
                                           value="{!! $advance->amount_to_pay !!}" readonly name="amount_to_pay">
