...
<tr>
    ...
    <td>{!! $employeeData['name'] ?? 'N/A' !!}
        <input type="hidden" name="employee_name[]"
            value="{!! $employeeData['name'] == null ? 'N/A' : $employeeData['name'] !!}">
    </td>
    <td>
        {!! $employeeData['employeeSalary'] == null ? 0 : $employeeData['employeeSalary'] !!}
        <input type="hidden" name="employee_salary[]"
            value="{!! $employeeData['employeeSalary'] == null ? 0 : $employeeData['employeeSalary'] !!}">
    </td>
    ...
    <td>
        ...
        !!}
        <input type="hidden" name="committedTime[]"
            value="{!! $employeeData['committedTime'] == null ? 0 : floatval(number_format($employeeData['committedTime']/60,2)) !!}">
    </td>
    ...
    <td>
        ...
        <input type="hidden" name="calculated_salary[]"
            value="{!! $employeeData['calculatedSalary'] == null ? 0 : $employeeData['calculatedSalary'] !!}">
    </td>

    <td>
        <input type="number" name="advanceInstallment[]"
            value="{!! $employeeData['advanceInstallment'] == null ? 0 : $employeeData['advanceInstallment'] !!}">
    </td>
    ...
    <td>
        <input type="hidden" name="total_values[]"
            value="{!! $employeeData['totalValues'] == null ? 0 : $employeeData['totalValues'] !!}">

        <input type="hidden" name="medicalAllowance[]"
            value="{!! $employeeData['medicalAllowance'] == null ? 0 : $employeeData['medicalAllowance'] !!}">
