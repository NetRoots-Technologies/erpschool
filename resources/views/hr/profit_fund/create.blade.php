        ...
        <div class="row">
            <div class="col-12">
                <div class="card basic-form">
                    <div class="card-body">
                        <h3 class="text-22 text-midnight text-bold mb-4"> Create PF </h3>
                        <div class="row    mt-4 mb-4 ">
                            <div class="col-12 text-right">
                                <a href="{!! route('hr.profit-funds.index') !!}" class="btn btn-primary btn-md"> Back </a>
                            </div>
                        </div>
                        @if ($errors->any())
                        ...
                        @endif
                        <form action="{!! route('hr.profit-funds.store') !!}" enctype="multipart/form-data"
