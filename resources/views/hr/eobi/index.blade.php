                    ...
                    <div class="card-body table-responsive">
                        <table class="w-100 table border-top-0 table-bordered   border-bottom " id="data_table">
                            ...
                            <tr>
                                ...
                                <th class="heading_style">Total</th>
                                <th class="heading_style">Amount From Employee</th>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            var dataTable = $('#data_table').DataTable({
                ...
                ajax: {
                    "url": "{{ route('datatable.data.eobiData') }}",
                    "type": "POST",
                ...
                "columns": [
                    ...
                    { data: 'employee_percent', name: 'employee_percent' },
