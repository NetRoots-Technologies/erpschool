            ...
            <div class="col-12">
                <div class="card basic-form">
                    <div class="card-header bg-light">
                        <h3 class="text-22 text-midnight text-bold mb-4">Edit Marketing Video</h3>
                    </div>
                    <div class="card-body">
                        @if ($errors->any())
                        ...
                        @endif
                        <form method="post" action="{!! route('admin.marketing_video.update',$data->id) !!}"
                            ...
                            <div class="row ">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input required type="text" class="form-control" value="{{$data->video_id}}" name="video_id">
                                    </div>
                                </div>
                            </div>
                            <div class="row ">
