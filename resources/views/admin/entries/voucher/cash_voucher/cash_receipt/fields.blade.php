    ...
    <div class="tab-content">
        <div class="tab-pane active" id="tab_1">
            <button onclick="FormControls.createEntryItem();" type="button" style="margin-bottom: 5px;"
                    class="btn mt-1 pull-right btn-sm btn-flat btn-primary"><i class="fa fa-plus"></i>&nbsp;Add <u>R</u>ow
            </button>
                    ...
                    <tr id="entry_item-2">
                        <td colspan="3">
                            <div class="form-group" style="margin-bottom: 0px !important;">
                                ...
                                <select name="trans_acc_from[]" class="form-control select2 description-data-ajax"
                                        id='entry_item-ledger_id-2'>
                                    <option value=""></option>
                                </select>
                            </div>
                        ...
                        <td>
                            <button onclick="FormControls.destroyEntryItem('2');" id="entry_item-del_btn-2"
