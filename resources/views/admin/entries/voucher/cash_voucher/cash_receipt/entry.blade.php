            ...
            <div class="col-12">
                <div class="card basic-form">
                    <div class="card-body">
                        ...
                        <a href="{{route('admin.entries.downloadPDF', $id)}}" target="_blank"
                           class="btn btn-warning pull-right" style="margin-right: 8px"> <u>P</u>df</a>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                <th>Department</th>
                                <td>@if($Department && isset($Department->name)){{ $Department->name }}@else
                                        N/A @endif</td>
                                <th>Employee</th>
                                <td>
                                    @if($Employee == '')
                        ...
                        <div class="nav-tabs-custom">
                            ...
                            <div class="tab-content container">
                                <div class="tab-pane active table-responsive col-md-12 " id="tab_1">
                                    <table class="table   w-100  mt-5" id="entry_items">
                                        <thead>
                                        <tr>
                                        ...
                                        @if(count($Entry_items))
                                            ...
                                            @foreach($Entry_items as $Entry_item)
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                        <div class="form-group" style="margin-bottom: 0px !important;">
                                                            @if($Entry_item->currenciesA)  {{ $Entry_item->currenciesA->code }} @else
                                                                N/A @endif
                                                        </div>
                                                    </td>
                                                    <td align="center">
                                                        <div class="form-group" style="margin-bottom: 0px !important;">
                                                            ...
                                                            @if($Entry_item->dc == 'd')
                                                                ...
                                                                @php  $dr_amount=$dr_amount+ $Entry_item->amount; @endphp
                                                                {{$Currency::curreny_format($Entry_item->amount) }}@else
                                                                0.00
                                                            @endif
                                                        </div>
                                                    </td>
                                                    <td align="center">
                                                        <div class="form-group" style="margin-bottom: 0px !important;">
                                                            @if($Entry_item->dc == 'c')
                                                                @php  $cr_amount=$cr_amount+ $Entry_item->amount; @endphp
                                                                {{$Currency::curreny_format($Entry_item->amount) }}@else
                                                                0.00
                                                            @endif
                                                        </div>
                                ...
                                <div class="tab-pane" id="tab_2">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td width="40%">@if($Entrie->cheque_no){{ $Entrie->cheque_no }}@else
                                                    N/A @endif</td>
                                        ...
                                        <tr>
                                            ...
                                            <th>Invoice Date</th>
                                            <td>@if($Entrie->invoice_date){{ $Entrie->invoice_date }}@else
                                                    N/A @endif</td>
                                        </tr>
                                        <tr>
                                            <th>CDR #</th>
                                        ...
                                        <tr>
                                            <th>Drawn Date</th>
                                            <td colspan="3">@if($Entrie->drawn_date){{ $Entrie->drawn_date }}@else
                                                    N/A @endif</td>
                                        </tr>
                                        </tbody>
                                    </table>
