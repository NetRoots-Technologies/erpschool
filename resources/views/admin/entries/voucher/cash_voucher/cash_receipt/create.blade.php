...
{{--            <h3 class="box-title">Create Cash Receipt Voucher</h3>--}}
...
{{--            </div>--}}
{{--        {!! Form::close() !!}--}}
{{--        @include('admin.entries.voucher.cash_voucher.cash_receipt.entries_template')--}}
{{--    </div>--}}
...
<div class="container">
    <div class="row justify-content-center p-4">
        <div class="row">
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header"><strong>Create Cash Receipt Voucher</strong> <span class="float-end"><a
...
{{--    <script src="{{ url('/js/admin/entries/voucher/cash_voucher/cash_receipt/create_modify.js') }}" type="text/javascript"></script>--}}
@endsection
