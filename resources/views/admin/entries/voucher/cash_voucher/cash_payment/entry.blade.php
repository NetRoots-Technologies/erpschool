...
@if($Entry_item->dc == 'c'){{$Currency::curreny_format($Entry_item->amount) }}@else
                                                    @endif
                                                        ...
                                                        <td align="center">
                                                            <div class="form-group" style="margin-bottom: 0px !important;">
                                                         @if(isset($Entry_item->itemCurrency))       {{ $Entry_item->itemCurrency->code }} @endif
                                                            </div>
                                                        </td>
                                                        <td align="center">
                                                            <div class="form-group" style="margin-bottom: 0px !important;">
                                                                @if($Entry_item->dc == 'd'){{$Currency::curreny_format($Entry_item->other_amount) }}@else 0.00
                                                                @endif
                                                            </div>
                                                        </td>
                                                        <td align="center">
                                                            <div class="form-group" style="margin-bottom: 0px !important;">
                                                                @if($Entry_item->dc == 'c'){{$Currency::curreny_format($Entry_item->other_amount) }}@else 0.00
                                                                @endif
                                                            </div>
                                                        </td>
                                                        {{--<td align="center">--}}
