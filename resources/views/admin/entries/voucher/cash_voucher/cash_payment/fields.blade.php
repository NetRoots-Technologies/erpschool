...
<div class="col-md-4 form-group">
    ...
    <select class="form-control select2" id="search_ledger_id" required name="trans_acc_to">
...
<div class="col-md-12 form-group">
    ...
    <input type="text" class="form-control" id="balance_info">
</div>
<!--<div class="form-group col-md-12  @if($errors->has('base_item')) has-error @endif">
    <table class="table table-condensed">
        <tbody>
            <tr>
                {{--@if(isset($VoucherData['entry_items']['counter']))--}}
...
{{--@endif--}}
    ...
    <td width="20%">
        <div class="form-group @if($errors->has('cr_total')) has-error @endif" style="margin-bottom: 0px !important;">
                            {{--{!! Form::label('cr_total', 'Cash Total', ['class' => 'control-label']) !!}--}}
...
{!! Form::hidden('entry_items[cr_amount][2]', null, [
                        ...
                        <div class="form-group">
                            <select class="form-control curr-select" name='currency_id[]' required>
                    ...
                    <td>
                        <button onclick="FormControls.destroyEntryItem('2');" id="entry_item-del_btn-2" type="button"
