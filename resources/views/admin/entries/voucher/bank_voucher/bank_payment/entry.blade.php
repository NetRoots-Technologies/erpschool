                                            ...
                                            @if(count($Entry_items))
                                                @foreach($Entry_items as $Entry_item)
                                                    <tr>
                                                        ...
                                                        <td align="center">
                                                            <div class="form-group" style="margin-bottom: 0px !important;">
                                                                {{ $Entrie->currenciesB->code }}
                                                            </div>
                                                        </td>
                                                        <td align="center">
                                                            <div class="form-group" style="margin-bottom: 0px !important;">
                                                                @if($Entry_item->dc == 'd'){{$Currency::curreny_format($Entry_item->other_amount) }}@else
                                                                @endif
                                                            </div>
                                                        </td>
                                                        <td align="center">
                                                            <div class="form-group" style="margin-bottom: 0px !important;">
                                                                @if($Entry_item->dc == 'c'){{$Currency::curreny_format($Entry_item->other_amount) }}@else
                                                                @endif
                                                            </div>
                                                        </td>
                                                        {{--<td align="center">--}}
