                ...
                <form id="budgetForm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" value="Annual" name="timeFrame" id="timeFrame"
                                readonly>
                        </div>

                        <div class="col-md-12 mb-3">
                            <label>Annual Amount</label>
                            <input type="number" name="amount" id="annualAmount" class="form-control" required>
                        </div>
        ...
        <div class="card mt-4 d-none" id="monthlyCard">
            ...
            <div class="card-body">
                ...
                <div class="text-end mt-3">
                    <button class="btn btn-success" id="finalSave">Final Save</button>
                </div>
            </div>
        </div>
...
@section('js')
    <script>
        ...
        // Jab allocated amount likho, allowed-spend me copy ho
