...
<div class="container-fluid">
    ...
    <div class="row mt-4 mb-4 justify-content-start gap-4">
     ...
     @if (Gate::allows('Company-create'))
        ...
        <div class="col-auto p-0">
            <a href="{{ route('academic.company.export-file') }}" class="btn btn-warning btn-md">
        ...
        <div class="col-auto p-0">
            <a href="{{route('print-preview', 'company')}}" class="btn btn-info btn-md">
                <b>Print Preview</b>
            </a>
        </div>
        @endif
    ...
    <div class="modal fade" id="importModal" tabindex="-1" aria-labelledby="importModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('academic.company.import-file') }}" method="POST" enctype="multipart/form-data">
                    @csrf
            ...
            <script type="text/javascript">
                ...
                $(document).ready(function () {
                    tableData = $('#file-datatable').DataTable({
                        ...
                        ajax: {
                            "url": "{{ route('datatable.company.getdata') }}",
                            "type": "POST",
                ...
                $('#tag-form-submit').on('click', function (e) {
                    ...
                    var id = $('#edit_id').val();
                    var url = "{{ route('admin.company.index') }}";
                    var loader = $('<div class="loader"></div>').appendTo('body');
