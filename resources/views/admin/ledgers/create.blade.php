...
<div class="container">
    <div class="row justify-content-center p-4">
        <div class="row">
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header"><strong>Create Ledger</strong> <span class="float-end"><a
                                href="{{ route('admin.ledgers.index') }}" class="btn btn-primary">Back</a></span>
                    </div>
                    <div class="card-body">
                        {!! Form::open(['method' => 'POST', 'route' => ['admin.ledgers.store'], 'id' =>
                        'validation-form']) !!}
                        @csrf
                        <div class="row">
...
<script src="{{ url('/js/admin/ledger_reports/ledger_report.js') }}" type="text/javascript"></script>
@endsection