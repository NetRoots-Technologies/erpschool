...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row w-100  mt-4 ">
            <h3 class="text-22 text-center text-bold w-100 mb-4"> Business Valley </h3>
                        ...
                        <div class="table-responsive">
                            <table class="table border-top-0 table-bordered border-bottom" id="data_table">
                                ...
                                <tr>
                                    ...
                                    <th>City</th>
                                    <th>Profession</th>
                                    <th>Proposed Investment Range</th>
                                    <th>Income</th>
                                    <th>Date</th>
                                </tr>
                                </thead>
    ...
    <script>
        ...
        $(document).ready(function () {
            tableData = $('#data_table').DataTable({
                ...
                ajax: {
                    "url": "{{ route('datatable.bv_form_get_data') }}",
                    "type": "POST",
                ...
                "columns": [
                    ...
                    {data: 'proposed_investment_range', name: 'proposed_investment_range'},
