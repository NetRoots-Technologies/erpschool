        ...
        <div class="col-12">
            <div class="page-header">
                <div class="page-leftheader">
                    <h4 class="page-title mb-0">Edit Fee Collection</h4>
                    <ol class="breadcrumb">
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.fee-management.collections.update', $collection->id) }}" method="POST" id="collectionForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div id="feeCategories">
                                    @if($collection->details && count($collection->details) > 0)
                                        @foreach($collection->details as $index => $detail)
                                            <div class="row mb-2" id="categoryRow{{ $index }}">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label>Category</label>
                                                        <div class="input-group">
                                                            <select class="form-control category-select" name="collections[{{ $index }}][category_id]" required>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label>Amount</label>
                                                        <input type="number" class="form-control amount-input" name="collections[{{ $index }}][amount]" 
                                                               value="{{ $detail->amount }}" placeholder="Amount" min="0" step="0.01" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label>&nbsp;</label>
                                                        <button type="button" class="btn btn-danger btn-sm remove-category" {{ count($collection->details) <= 1 ? 'style=display:none' : '' }}>
                ...
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li>• Collection can be edited after saving</li>
                        </ul>
                    </div>
                </div>
            </div>
...
<script>
    $(document).ready(function() {
        let categoryCount = {{ $collection->details ? count($collection->details) : 1 }};
        ...
        function updateRemoveButtons() {
            ...
            rows.each(function() {
                const removeBtn = $(this).find('.remove-category');
                if (rows.length <= 1) {
                    removeBtn.hide();
                } else {
                    removeBtn.show();
