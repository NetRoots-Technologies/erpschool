            ...
            <div class="page-header">
                ...
                <div class="page-rightheader">
                    ...
                    <a href="{{ route('admin.fee-management.collections.pay-challan') }}" class="btn btn-success ml-2">
                     ...
                     <a href="{{ route('admin.fee-management.template.download.fee.collection') }}" class="btn btn-danger">
                        <i class="fa fa-download"></i> Download Collection Template
                    </a>
  ...
  <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.fee-management.fee.collection.import') }}" method="POST" enctype="multipart/form-data">
                    @csrf
