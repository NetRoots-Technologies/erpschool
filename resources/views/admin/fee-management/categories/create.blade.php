    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.fee-management.categories.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('type') is-invalid @enderror" 
                                        ...
                                        <option value="allocation" {{ old('type') == 'allocation' ? 'selected' : '' }}>Allocation</option>
                                    </select>
                                    @error('type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="form-group">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="affects_financials" 
                                               name="affects_financials" value="1" {{ old('affects_financials') ? 'checked' : '' }}>
