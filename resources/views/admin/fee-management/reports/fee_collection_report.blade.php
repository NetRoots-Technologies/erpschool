                            ...
                            <table class="table table-striped table-vcenter text-nowrap mb-0" id="feeTable">
                                <thead>
                                    <tr>
                                        <td>Student ID</td>
                                        <td>Student Name</td>
                                        <td>Fee Bill Amount</td>
                                        <td>Applied Discount with percentage (%)</td>
                                        <td>Applied Discount with amount (Rs.)</td>
                                    </tr>
                                </thead>
                                <tbody></tbody>
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        ...
                                        <td></td>
                                        <td></td>
                                        <td colspan="1">Total Discount: <span id="discount_avg">0%</span></td>
                                        <td colspan="1">Total Amount Discount: <span id="total_discount_amount">0%</span></td>
                                    </tr>
                                </tfoot>
        ...
        $(document).ready(function() {
            ...
            var table = $('#feeTable').DataTable({
                ...
                drawCallback: function(settings) {
                    ...
                    // var totalFee = api.ajax.json().total_fee;
                    var totalDiscount = api.ajax.json().total_discount;

                    // Update the footer with correct totals in a single row
                    $('#discount_avg').html(avgDiscount + '%');
                    // $('#total_fee').html(totalFee);
                    $('#total_discount_amount').html(totalDiscount);
                }
            });
