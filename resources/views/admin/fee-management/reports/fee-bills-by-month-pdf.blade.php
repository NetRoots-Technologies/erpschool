...
@section('title', 'Fee Bills By Month')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-header">
                    ...
                    <h4 class="page-title mb-0">Fee Bills By Month</h4>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Fee Bills By Month</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <form method="GET" action="{{ route('admin.fee-management.reports.fee-bills-by-month-pdf-download') }}">
