                ...
                <form action="{{ route('admin.fee-management.billing.generate') }}" method="POST" id="generateBillingForm">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="billing_class_id" class="form-label">Class <span
                                            class="text-danger">*</span></label>
                                    <select class="form-control select2" id="billing_class_id" name="academic_class_id"
                                        required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="billing_session_id" class="form-label">Session <span
                                            class="text-danger">*</span></label>
                                    <select class="form-control" id="billing_session_id" name="academic_session_id"
                                        required>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="billing_month" class="form-label">Billing Month <span
                                            class="text-danger">*</span></label>
    ...
    <script>
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            return data ? new Date(data + '-01').toLocaleDateString('en-US', {
                                year: 'numeric',
                                month: 'long'
                            }) : 'N/A';
                        }
        ...
        $(function() {
            ...
            $class.on('change', function() {
                ...
                const url = "{{ route('admin.fee-management.class.students', ':id') }}".replace(':id',
                    ...
                    success: function(res) {
                        ...
                        if (Array.isArray(res) && res.length) {
                            res.forEach(function(s) {
                                $student.append('<option value="' + s.id + '">' + s
                                    .name + '</option>');
                            });
        ...
        $(document).ready(function() {
            ...
            $('#generateBillingModal').on('shown.bs.modal', function() {
                $('#billing_class_id').select2({
                    ...
                    width: '100%',
                    dropdownParent: $(
                        '#generateBillingModal') // Modal ke andar dropdown properly render ho
                });
            });
