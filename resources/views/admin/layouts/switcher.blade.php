...
{{--                                    <div class="">--}}
{{--                                        <input class="wd-25 ht-25 input-color-picker color-primary-light" value="#0162e8" id="colorID" oninput="changePrimaryColor()" type="color" data-id="bg-color" data-id1="bg-hover" data-id2="bg-border"  data-id7="transparentcolor"  name="lightPrimary">--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                        </div>--}}
...
{{--                                    <div class="">--}}
{{--                                        <input class="wd-25 ht-25 input-dark-color-picker color-primary-dark" value="#0162e8" id="darkPrimaryColorID" oninput="darkPrimaryColor()" type="color" data-id="bg-color" data-id1="bg-hover" data-id2="bg-border" data-id3="primary"  data-id8="transparentcolor" name="darkPrimary">--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                        </div>--}}
...
{{--                                    <div class="">--}}
{{--                                        <input class="wd-30 ht-30 input-transparent-color-picker color-primary-transparent" value="#0162e8" id="transparentPrimaryColorID" oninput="transparentPrimaryColor()" type="color" data-id="bg-color" data-id1="bg-hover" data-id2="bg-border" data-id3="primary" data-id4="primary"  data-id9="transparentcolor" name="tranparentPrimary">--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                                <div class="switch-toggle d-flex mt-2">--}}
{{--                                    <span class="me-auto">Transparent Background</span>--}}
{{--                                    <div class="">--}}
{{--                                        <input class="wd-30 ht-30 input-transparent-color-picker color-bg-transparent" value="#0162e8" id="transparentBgColorID" oninput="transparentBgColor()" type="color" data-id5="body" data-id6="theme"  data-id9="transparentcolor" name="transparentBackground">--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                        </div>--}}
...
{{--                                    <div class="">--}}
{{--                                        <input class="wd-30 ht-30 input-transparent-color-picker color-primary-transparent" value="#0162e8" id="transparentBgImgPrimaryColorID" oninput="transparentBgImgPrimaryColor()" type="color" data-id="bg-color" data-id1="bg-hover" data-id2="bg-border" data-id3="primary" data-id4="primary"  data-id9="transparentcolor" name="tranparentPrimary">--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                                <div class="switch-toggle">--}}
{{--                                    <a class="bg-img1" onclick="bgImage(this)" href="javascript:void(0);"><img src=" {!! URL::asset('dist/assets/img/media/bg-img1.jpg') !!}" id="bgimage1" alt="switch-img"></a>--}}

{{--                                    <a class="bg-img2" onclick="bgImage(this)" href="javascript:void(0);"><img src="{!! URL::asset('dist/assets/img/media/bg-img2.jpg') !!}"  id="bgimage2" alt="switch-img"></a>--}}
{{--                                    <a class="bg-img3" onclick="bgImage(this)" href="javascript:void(0);"><img src="{!! URL::asset('dist/assets/img/media/bg-img3.jpg') !!}"  id="bgimage3" alt="switch-img"></a>--}}
{{--                                    <a class="bg-img4" onclick="bgImage(this)" href="javascript:void(0);"><img src="{!! URL::asset('dist/assets/img/media/bg-img4.jpg') !!}"  id="bgimage4" alt="switch-img"></a>--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                        </div>--}}
{{--                    </div>--}}
