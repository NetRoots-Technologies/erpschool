...
@section('content')
    {!! Form::open(['route' => 'maintainer.building.store', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {{ Form::text('name', null, ['class' => 'form-control', 'placeholder' => __('Enter Building Name')]) }}
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {{ Form::number('area', null, ['class' => 'form-control', 'placeholder' => __('Enter Building Area'), 'step' => '0.1']) }}
                            </div>
                        </div>
            ...
            $(document).ready(function() {
                $('#company_id').on('change', function() {
                    ...
                    if (companyId) {
                        ...
                        $.ajax({
                            url: "{{ route('maintainer.get.branch') }}",
                            type: "GET",
                            data: {
