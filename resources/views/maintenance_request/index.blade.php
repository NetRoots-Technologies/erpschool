...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row w-100  mt-4 ">
            <h3 class="text-22 text-center text-bold w-100 mb-4"> Maintenance Request </h3>
        </div>
        <div class="row mt-4 mb-4 ">
            ...
            <div class="col-auto p-0">
                ...
                <a href="{{ route('maintenance-request.create') }}" class="btn btn-primary btn-md"
                    style="margin-left: 15px; color: #212529 !important;">
                    <b>Add Maintenance Request</b>
                </a>
            </div>
            {{-- @endif --}}
        </div>
            ...
            <script type="text/javascript">
                ...
                $(document).ready(function() {
                    tableData = $('#maintenance_request').DataTable({
                        ...
                        ajax: {
                            "url": "{{ route('maintenance-request.index') }}",
                            "type": "GET",
                            "data": {
                                _token: "{{ csrf_token() }}"
                            }
