...
var FormControls = function () {
    ...
    var addTable = function(table_data, gross_amount, tax_amount, tax_percent){
        ...
        if(table_data.length > 0){
            ...
            document.getElementById('users-table').style.visibility = "visible";
            ...
            document.getElementById('users-table').style.visibility = "hidden";
            document.getElementById('due_date').setAttribute('readonly');
            document.getElementById('rr_no').setAttribute('readonly');
            document.getElementById('btn_save').setAttribute('disabled');
            document.getElementById('delivery_type').setAttribute('disabled');
        }
    }
