...
Route::get('/zkt-test-connection', [ZktecoController::class, 'testConnectionPage'])->name('zkt-test-connection');
Route::get('/zkt-test-connection-api', [ZktecoController::class, 'testConnection'])->name('zkt-test-connection-api');
